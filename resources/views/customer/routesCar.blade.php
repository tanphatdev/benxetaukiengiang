        ...
        <a href="javascript:void(0)" onclick="openList(event, 'TuyenXe');">
            <div class="w3-third tablink w3-bottombar w3-hover-light-grey w3-padding">
                <div style="text-align: left;font-size:18px;color: #135190;">
                    <span><strong>DANH SÁCH TUYẾN XE</strong></span>
                </div>
            </div>
        </a>
    </div>
    <div id="TuyenXe" class="w3-container list" style="display:unset">
        <div class="card-body">
                        ...
                        @foreach ($tuyenxe as $row)
                            <tr>
                                ...
                                <td style="text-align:center">
                                        ...
                                        <a href="/gettuyenxetau/tuyenxe?noidi={{ $row->tuyen_bendi }}&noiden={{ $row->tuyen_benden }}" style="border-radius: 50%;"  >
                                            <i class="fa fa-bus" style="color: #27619c"></i>
                                        </a>
