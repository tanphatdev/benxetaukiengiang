            ...
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-header">
                        <h2 style="margin-top: 8px;">Thêm mới bài viết</h2>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="/manager/posts/create" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="img-preview-container d-none position-relative">
                                            <img id="preview" class="img-thumbnail" style="width: 100%;">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="submit" class="btn btn-primary mr-2" style="font-size: 16px;">Thêm mới bài
                                    viết</button>
                            </div>
                        </form>
                    </div>
